...
public class PlatformLayeringTests
{
    ...
    public void NoPlatformAssembly_EverReferencesAnythingNamedAgoChat()
    {
        ...
        AssertNoAgoChatDependency(
            typeof(Ago.Platform.Observability.ObservabilityServiceCollectionExtensions).Assembly, "Ago.Platform.Observability");
        ...
        AssertNoAgoChatDependency(typeof(Ago.Platform.Realtime.RedisConnectionRegistry).Assembly, "Ago.Platform.Realtime");
    }
